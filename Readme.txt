...
20221113 // Забрав з таблиці select box ( тепер видідення  цілим рядком)
20221114 // Переніс в Footr вибір к-сті рядків на сторінці
...
20231120 // Добавив задання фільтрів по полях: DropdownFilter.js+DroopFifterForm.js
20231124 // Одиночний фільтр/Очистка фільтрів і відкат

!! Доробити:    Фільтри по даті і.....
                ВІдмітити всі/зняти
                Суми по стовбцях
