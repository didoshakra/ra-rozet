...
const HeaderTape = () => {
  ...
  return (
    ...
    <div className="mx-auto my-auto flex h-16 max-w-full flex-col justify-start bg-tapeMenuBg px-2 text-sm text-white dark:bg-tapeMenuBgDark md:h-6 md:flex-row md:justify-between ">
