  ...
  return (
    ...
    <div className=" justify-begin flex min-w-[200px]  items-center px-0 md:px-2  ">
      <Link href="/">
        ...
        <Image
          src="/images/home/irunka-logo.png"
          width={80}
          height={20}
          alt="Logo"
        />
      ...
      {/* <Link href="/">
        <div className="flex text-2xl md:text-2xl font-bold italic text-headMenuText dark:text-headMenuTextDark items-center px-4 justify-begin">
          RAproducts
        </div>
      </Link> */}
      {/* ========================================================================== */}
