...
export default function DrawerDroop({ drawerOpen, setDrawerOpen }) {
  ...
  return (
    <div
      ...
      //Виїжджає Зліва
      className={`md:w-[50vw] fixed -left-[100vw] top-50 z-20 flex h-full w-[100vw] flex-col overflow-y-scroll bg-drawDropMenuBg  dark:bg-drawDropMenuBgD md:-left-[50vw] ${
