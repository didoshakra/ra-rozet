...
export default async function Home() {
  ...
  return (
    <section className="flex flex-col space-y-2 px-2 pb-5 pt-5 text-center  text-hText dark:text-hTextD">
      <h1 className=" text-4xl font-bold">Пропозиції дня</h1>
      <h2 className=" text-2xl italic text-red-500">Тільки якісні продукти</h2>
